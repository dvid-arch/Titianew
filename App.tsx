        ...
        <section className="flex flex-col items-center mb-64" id="home">
          ...
          <div className="relative w-full text-center">
            ...
            <div className="relative overflow-visible">
              <motion.h1 
                className="text-[60px] sm:text-[60px] md:text-[100px] lg:text-[140px] font-black leading-[0.85] tracking-[-0.05em] text-gradient uppercase mb-12 whitespace-nowrap lg:whitespace-normal"
              >
